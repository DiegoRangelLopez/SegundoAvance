...
export default {
  data: () => ({
      bpm: 1,
    products: [
      { img: "pr1.png", title: "Coliflor", subtitle: "1kg", price: "$13" },
      { img: "pr2.png", title: "Helado de Canela", subtitle: "1kg", price: "$23" },
      { img: "pr3.png", title: "Patata", subtitle: "1kg", price: "$17" },
      { img: "pr4.png", title: "Snacks de frutas", subtitle: "Patatas, papaya, aceite y coliflor", price: "$40" },
      { img: "pr5.png", title: "Galletas Oreo THIN", subtitle: "270GM", price: "$20" },
