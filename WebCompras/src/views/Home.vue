      ...
      <v-row>
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="cover2.png" max-height="100%" max-width="100%" contain>
              <v-card-title class="top ml-10">
                <h2 class="title1">¡Ordena ahora!</h2>
              </v-card-title>
              <v-card-title class="ml-10 mt-n8">
                <h2 class="title2">Grocerias del día B)</h2>
              </v-card-title>
              <v-card-text class="ml-10">
                <h3 class="green--text">#Domicilio gratis</h3>
              </v-card-text>
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
          ...
          <v-toolbar flat color="transparent">
            <v-toolbar-title class="text-h6">Categorias de nuestra tienda</v-toolbar-title>
            <v-spacer></v-spacer>
          ...
          <v-toolbar flat color="transparent" class="mt-5">
            ...
            <v-spacer></v-spacer>
            <v-btn rounded color="green" dark class="px-8">Ver todo</v-btn>
          </v-toolbar>
          <Product />
          <v-card flat color="#E2F2E5" class="rounded-xl mt-8">
            <v-toolbar flat color="transparent" class="mb-4">
              <v-toolbar-title class="text-h6 mt-5"
                >Packs de frutas populares</v-toolbar-title
              >
              <v-spacer></v-spacer>
            </v-toolbar>
            <Pack />
          ...
          <v-card flat color="#FAFAFA" class="mt-8 py-5 px-16">
            <div
              ...
              "
            >
              <h3>¿Qué dicen nuestros cliente de nosotros?</h3>
            </div>
            <Client />
          </v-card>
          <v-toolbar flat color="transparent" class="mt-8">
            <v-toolbar-title class="text-h6"
              >Nuestros patrocinadores</v-toolbar-title
            >
          </v-toolbar>
          <Partner />
          <v-card
          ...
          >
            <v-row>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                <h1 class="mt-16">¡También encuentranos a través de tu celular!</h1>
                <p>
                  ¡Descarga ya nuestra aplicación para moviles y encuentra más facil todo lo que necesitas!
                </p>
